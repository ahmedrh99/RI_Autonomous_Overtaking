...
def generate_launch_description():
    ld = launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('publish_tf', default_value='False'),
        launch.actions.DeclareLaunchArgument('tf_update_rate', default_value='50.0'),
        ...
        launch_ros.actions.Node(
            ...
            parameters=[
                ...
                { 'tf_update_rate': launch.substitutions.LaunchConfiguration('tf_update_rate') }
            ]
        )
    ])
    return ld
