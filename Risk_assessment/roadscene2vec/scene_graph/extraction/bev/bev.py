...
class BEV():
    ...
    def apply_depth_estimation(self, x, y):
        return (x * self.params['xscale']*0.3048, y * self.params['yscale'] * 0.3048)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--cal_im_path', type=str, default= 'C:/Users/riahi/carla/CARLA_0.9.15/carla_latest/PythonAPI/examples/roadscene2vec/examples/raw_images/0/00000.png', help="The path defining location of image used to calibrate BEV.")
    path = ap.parse_args().cal_im_path
    bev = BEV(path, mode='calibrate')
    bev.calibrate()#/sequences/frame_195085.jpg'