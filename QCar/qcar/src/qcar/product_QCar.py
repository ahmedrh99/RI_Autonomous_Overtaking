...
class QCar():
    ...
    def write_mtrs(self, mtr_cmd):
        ...
        self.write_other_buffer_steering[0] = -saturate(mtr_cmd[1], 0.5 + float(os.getenv('STEERING_TRIM')), -0.5 + float(os.getenv('STEERING_TRIM')))
    ...
    def write_std(self, mtr_cmd, LEDs):
        ...
        self.write_pwm_buffer_throttle[0] = -saturate(mtr_cmd[0], 0.2, -0.2)
        self.write_other_buffer_str_LEDs[0] = -saturate(mtr_cmd[1], 0.5 + float(os.getenv('STEERING_TRIM')), -0.5 + float(os.getenv('STEERING_TRIM')))
